...
app.get('/api/:temp/:humid', function(req, res){
    sendMessage(2546056792138320, "BOT: " + req.params.temp + " : " + req.params.humid);
    res.status(200).send("OK");
});
...
function sendMessage(senderId, message) {
    request({
        ...
        qs: {
            access_token: "EAAjZCDIg03E0BADS4uJwHfx8i4I5F2xAaswqnhX3F4ysR4xjZAZC9Ph9zkGLZAKyYwptLB5HmbDAHwCZCXZBZCcb237i2DwyoZCuijditMaFe1WNwUAmmP7j24XjP5GXhUqatghbKDEOC3xr3whExBkZBfD7pnIm9rWZCZCrUpT8RrSSt4yU1ZAgZAxVyuhQEycoHO6gZD",
        },
        method: 'POST',
        json: {
            recipient: {
